...
WP_L10n_Validator::register_config_callback( function( $parser ) {
	...
	$parser->add_ignored_functions(
		array(
			...
			'WordPoints_Extension_Upgrader::bail_early' => true,
	...
	$parser->add_ignored_properties(
		array(
			...
			'WordPoints_Entity_Attr_Stored_DB_Table::$data_type' => true,
			'WordPoints_Entity_Attr_Stored_DB_Table::$attr_field' => true,
			'WordPoints_Entity_Attr_Stored_DB_Table::$entity_id_field' => true,
