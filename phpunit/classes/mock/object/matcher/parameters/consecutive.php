...
/**
 * Consecutive parameters mock object matcher class.
 *
 * Based on PHPUnit_Framework_MockObject_Matcher_ConsecutiveParameters.
 *
 * @package WordPoints
 * @since   2.4.0
 */
 ...
 *
 * It takes a list of match groups and increases a call index after each
 * invocation. So the first invocation uses the first group of constraints, the
 * second the next and so on.
 */
class WordPoints_PHPUnit_Mock_Object_Matcher_Parameters_Consecutive
	 ...
	 */
	private function verifyInvocation(
